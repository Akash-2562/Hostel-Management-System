...
function Home() {
 ...
 var stud6=localStorage.getItem('admin');
  stud6 =JSON.parse(stud6);
  ...
  const [suggestions, setSuggestions] = useState([
        ...
        {
          "id": 1,
          "title": "Arjun [ Room: 368 ]",
          "desc": "from 28-5-2023 to 29-5-2023"
        },
        {
          "id": 1,
          "title": "Priya [ Room: 368 ]",
          "desc": "from 28-5-2023 to 29-5-2023"
        }
  ...
  return (
    <div className="w-full h-screen flex flex-col gap-3 items-center justify-center max-h-screen overflow-x-hidden overflow-y-auto pt-[400px] sm:pt-96 md:pt-96 lg:pt-80 xl:pt-20">
      <h1 className="text-white font-bold text-5xl text-center">
        Welcome <span className="text-blue-500">{stud6.name}  </span>
      </h1>
      <h1 className="text-white text-xl">Manager, INDIVAR BHAWAN</h1>
